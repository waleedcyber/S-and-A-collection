...
from schemas import OrderCreate, OrderItem, OrderOut,ProductRequestSchema
...
def create_order(order: OrderCreate, db: Session = Depends(get_db)):
    ...
    new_order = Order(
        ...
        customer_address=order.address,  # if you added this in schema + model
